...
var book4Title = "Pride and Prejudice";  // 1. Added fourth book
var book4Author = "Jane Austen";

console.log("There are four books now...");
console.log(book1Title + " by " + book1Author);
console.log(book2Title + " by " + book2Author);
console.log(book3Title + " by " + book3Author);
console.log(book4Title + " by " + book4Author); // 2. Updated to include fourth book
